...
var jHtml = $("html")
    var jBody = $("body")
    var jPreloader = $("#page-preloader")
    var jContainer = $("#justdance-nextgen")
    var jInterface = $("#interface")
    var jAdminMenu = $("#admin-menu")
    var jPunct = $("#punct")
    var jAdminTutorial = $("#game-tutorial")
    var jHUD = $("#hud")
    var jPlayers = $("#players")
    var jPictos = $("#pictos")
    var jBeat = $("#beat")
    var jRaceTrack = $("#racetrack")
    var jGoldMove = $("#goldmove")
    var jCoverFlow = $("#coverflow")
    var jWall = $("#jdWall")
    var jWallWin = $("#jdWall-window")
    var jSongSelection = $("#songselection")
    var jCtrlDesc = $("#controll-desc")
    var jWDF = $("#wdf")
    var jBottomCtrl = $("#bottom-controls")
    var jViews = $("#views")
    var jSongSelect = $("#songselect")
    var jCoachSelection = $("#coachselection")
    var jAfterDance = $("#afterdance")
    var jVideoDance = $("#video-map")
    var jMBG = $("#main-bg")
    ...
    $('.songSelected-border').css({
        'display': 'none'
    })

    jWallWin.addClass('hidden');
...
jAdminTutorial.addClass('hidden');
...
$(document).ready(function () {
    $('.item-lists').slick({
        ...
        speed: 500,
        easing: 'linear',
        infinite: true, // for Next Gen consoles
        draggable: true, // slide // on PC
        swipe: true, // on Mobile
...
var $coachSelectionMaket = $('<div class="backToCoverflow coachSelection"><div class="icon"></div><div class="title">Back</div></div><div class="song-details_"><div class="artist-name_">TBD</div><div class="map-name_">Dummy</div></div><div class="tutorial-title"><em>Choose your favorite dancer</em></div><div class="coachs-list" coach-count="1"><div class="coach-list list-1"><div class="coach-img"><img class="coach-img_" src="https://jdnow-api-contentapistoragest.justdancenow.com/songs/WantUBack_1598617448943/assets/common/coaches/wantuback_coach_1_big.png"></div><div class="selected-players"><div class="coachS color-1 blue"><div class="title">Step in!</div><div class="border"></div><div class="color"></div></div><div class="coachS color-2 red"><div class="title">Step in!</div><div class="border"></div><div class="color"></div></div><div class="coachS color-3 orange"><div class="title">Step in!</div><div class="border"></div><div class="color"></div></div><div class="coachS color-4 purple"><div class="title">Step in!</div><div class="border"></div><div class="color"></div></div></div></div></div><div class="song-action-button"><div class="title">Dance now!</div><div class="icon"></div></div>');

$(document).ready(function () {
    $('.big_cover_generic').on('click', function () {
        jHtml.removeClass('state-interested');
        jHtml.addClass('state-coachselection');
        jCoachSelection.css({
            'display': 'block'
        });
        jSongSelect.css({
...
$(document).ready(function () {
    $('.song-cover-generic').on('click', function () {
        jHtml.removeClass('state-interested');
        jHtml.addClass('state-coachselection');
        jCoachSelection.css({
            'display': 'block'
...
$(document).ready(function () {
    $('.big_cover').addClass('manyItems');
});

$(document).ready(function () {
    $('.song-cover-reward').addClass('locked');
});

$(document).ready(function () {
    $('.closeAdmin').on('click', function () {
        jAdminMenu.removeClass('visible');
...
$(document).ready(function () {
    $('.general-account').on('click', function () {
        jAdminMenu.addClass('visible');
        jHtml.addClass('dialog');
        jHtml.removeClass('state-songselection');
        jViews.css({
            'display': 'none'
        });
    });
...
$(document).ready(function () {
    $('.deBug').on('click', function () {
        $('.debug').addClass('isActivate');
        $('.debug-window').addClass('isActivate');
    });
});

$(document).ready(function () {
    $('.sweatActivate').on('click', function () {
        jRaceTrack.removeClass('isSweat');
    });
});

$(document).ready(function () {
    $('.notif-activ').on('click', function () {
        $('.notification').addClass('visible');
        $('.notification-rate').addClass('visible');
    });
});

$(document).ready(function () {
    $('.notif-deactiv').on('click', function () {
        $('.notification').removeClass('visible');
        $('.notification-rate').removeClass('visible');
    });
});

$(document).ready(function () {
    $('.dance-activ').on('click', function () {
        jHtml.addClass('state-dance');
        jHtml.removeClass('state-interested');
        jHtml.removeClass('state-coachselection');
        jHtml.removeClass('state-afterdance');
        jHtml.removeClass('state');
        jCoachSelection.css({
            'display': 'none'
        });
    });
...
$(document).ready(function () {
    $('.dance-deactiv').on('click', function () {
        jHtml.removeClass('state-dance');
        jCoverFlow.css({
            'display': 'block'
        });
        jVideoDance.css({
...
$(document).ready(function () {
    $('.backToCoverflow').on('click', function () {
        jHtml.removeClass('state-interested');
        jHtml.addClass('state-songselection');
        jCoverFlow.css({
            'display': 'block'
...
$(document).ready(function () {
    $('.cover-coach').on('click', function () {
        jHtml.addClass('state-interested');
        jHtml.removeClass('state-songselection');
        jCoverFlow.css({
            'display': 'none'
        });
        ...
        $('.loading-container').css({
            'display': 'block',
            'animation': 'loadContainerVisible 2s ease'
        });
    });
});
...
$(document).ready(function () {
    $('.backToCoverflow.preview').on('click', function () {
        jHtml.removeClass('state-interested');
        jHtml.addClass('state-songselection');
        jSongSelect.css({
            'display': 'none'
        ...
        $('.lhs-positions').remove();
    });
});

$(document).ready(function () {
    $('.backToCoverflow.coachSelection').on('click', function () {
        jHtml.removeClass('state-coachselection');
        jHtml.addClass('state-interested');
        jCoverFlow.css({
            'display': 'none'
        ...
        $('.coachS').removeClass('select');
    });
});

$(document).ready(function () {
    $('.am-item-list.credits').on('click', function () {
        jHtml.addClass('state-songselection');
        jHtml.removeClass('state-dance');
        jHtml.removeClass('state-interested');
        jHtml.removeClass('state-coachselection');
...
$(document).ready(function () {
    $('.inter-many').on('click', function () {
        $('.big_cover').addClass('manyItems');
    });
});

$(document).ready(function () {
    $('.inter-solo').on('click', function () {
        $('.big_cover').removeClass('manyItems');
    });
});

$(document).ready(function () {
    $('.coachS.color-1').on('click', function () {
        $('.coachS.color-1').toggleClass('select');
    });
});

$(document).ready(function () {
    $('.coachS.color-2').on('click', function () {
        $('.coachS.color-2').toggleClass('select');
    });
});

$(document).ready(function () {
    $('.coachS.color-3').on('click', function () {
        $('.coachS.color-3').toggleClass('select');
    });
});

$(document).ready(function () {
    $('.coachS.color-4').on('click', function () {
        $('.coachS.color-4').toggleClass('select');
    });
});

var $mapVideo = $('<video autoplay><source src="https://cdn.glitch.com/a34690a7-28a9-41f2-b75c-eb3501ba1fdd%2FSambaDeJaneiro_Ultra.webm" type="video/mp4; codecs=&quot;avc1.42E01E, mp4a.40.2&quot;">The video tag is not supported by your browser.</source></video>');

$(document).ready(function () {
    $('.song-action-button').on('click', function () {
        $('.dance-transition').addClass('animated');
        jHtml.addClass('state-dance');
        jHtml.removeClass('state-coachselection');
        jCoachSelection.css({
            'display': 'none'
        ...
        jVideoDance.append($mapVideo);
    });
});

$(document).ready(function () {
    $('.danceToCoveflow').on('click', function () {
        $('.dance-transition').removeClass('animated');
        jHtml.removeClass('state-dance');
        jHtml.removeClass('state-songselection');
        jCoverFlow.css({
            'display': 'block'
...
$(document).ready(function () {
    $('.jdWall-button').on('click', function () {
        jWallWin.addClass('visible');
        jHtml.removeClass('state-songselection');
        jHtml.addClass('state-jdwall');
        jSongSelection.css({
            'display': 'none'
        });
        jWDF.css({
...
$(document).ready(function () {
    $('.backToCoverflow.jdWallToCoveflow').on('click', function () {
        jWallWin.addClass('hidden');
        jWallWin.removeClass('visible');
        jHtml.addClass('state-songselection');
        jHtml.removeClass('state-jdwall');
        jSongSelection.css({
            'display': 'block'
        });
        jWDF.css({
...
var $hiScoresPanel = $('<div class="his pos-1"><div class="position">1</div><div class="avatar"><img class="avatar-img" src="https://jdnow-api-contentapistoragest-demo.justdancenow.com/avatars/1.png"></div><div class="player-dancercard"><div class="nickname"><em>Dev_Player_1</em></div><div class="score"><em>6000</em></div></div><div class="stars-result" data-stars="3"><div class="his-star star-5"></div><div class="his-star star-4"></div><div class="his-star star-3"></div><div class="his-star star-2"></div><div class="his-star star-1"></div></div></div><div class="his pos-2"><div class="position">2</div><div class="avatar"><img class="avatar-img" src="https://jdnow-api-contentapistoragest-demo.justdancenow.com/avatars/2.png"></div><div class="player-dancercard"><div class="nickname"><em>Dev_Player_2</em></div><div class="score"><em>4000</em></div></div><div class="stars-result" data-stars="2"><div class="his-star star-5"></div><div class="his-star star-4"></div><div class="his-star star-3"></div><div class="his-star star-2"></div><div class="his-star star-1"></div></div></div><div class="his pos-3"><div class="position">3</div><div class="avatar"><img class="avatar-img" src="https://jdnow-api-contentapistoragest-demo.justdancenow.com/avatars/3.png"></div><div class="player-dancercard"><div class="nickname"><em>Dev_Player_3</em></div><div class="score"><em>2000</em></div></div><div class="stars-result" data-stars="1"><div class="his-star star-5"></div><div class="his-star star-4"></div><div class="his-star star-3"></div><div class="his-star star-2"></div><div class="his-star star-1"></div></div></div>');

$(document).ready(function () {
    $('.cover-coach').on('click', function () {
        $('.lhs-positions').append($hiScoresPanel);
    });
});

$(document).ready(function () {
    $('.am-item-list.tutorials').on('click', function () {
        jAdminTutorial.addClass('visible');
        jAdminTutorial.removeClass('hidden');
        jAdminMenu.removeClass('visible');
        jAdminMenu.addClass('hidden');
    });
});
